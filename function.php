...
function get_book_return_day_limit($connect)
{
	$output = 0;
	$query = "
...
function get_per_user_book_issue_limit($connect)
{
	$output = 0;
	$query = "
...
{
	$query = "
	SELECT author_name,author_id FROM lms_author 
...
{
	$query = "
	SELECT category_name,category_id FROM lms_category 
...
{
	$query = "
	SELECT location_rack_name,location_rack_id FROM lms_location_rack 
